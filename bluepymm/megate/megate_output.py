...
def _write_pure_extended_neuron_db(ext_neuron_db, filename):
...
def save_megate_results(ext_neuron_db, pure_ext_neuron_db_filename,
                        ext_neuron_db_filename):
    ...
    Args:
        ...
        pure_ext_neuron_db_filename (str): filename of 'pure' database
        ext_neuron_db_filename (str): filename of 'full' database
    """
    ext_neuron_db = ext_neuron_db.sort_index()
    _write_pure_extended_neuron_db(ext_neuron_db, pure_ext_neuron_db_filename)
    ext_neuron_db.to_csv(ext_neuron_db_filename, index=False)
